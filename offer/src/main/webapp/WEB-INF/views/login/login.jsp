...
<body>
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-gradient-primary">
            <div class="auth-box border-top border-secondary" style="border-color:white; background-color: #ffffff; background-color: rgba( 255, 255, 255, 0 );">
                <div id="loginform">
                    ...
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="loginform" action="/login/loginProcess">
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" id="ch_id" name="ch_id" placeholder="ID" aria-label="ID" aria-describedby="basic-addon1" required="">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
